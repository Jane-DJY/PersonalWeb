...
import TheLighthouseImg from '../assets/images/projects/TheLighthouse.png';
import TwinCloudImg from '../assets/images/projects/TwinCloud.png';
import StockForestImg from '../assets/images/projects/StockForest.png';
import WomensAsianGameImg from '../assets/images/projects/Women\'sAsianGame.png';
import LongerMovieImg from '../assets/images/projects/LongerMovie.png';
import WhoRunsChinaImg from '../assets/images/projects/WhoRunsChina.png';
    ...
    <div className="projects-container">
      ...
      <div className="projects-grid">
        {projects.map((project, index) => (
          <div key={index} className={`project-card interactive fade-in delay-${index % 3 + 1}`}>
